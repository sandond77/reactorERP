...
const MIGRATION_FIELDS: Record<MigrationType, FieldSpec[]> = {
  graded: [
    ...
    { name: 'card_number',   required: false, description: 'Card number within the set — numerator only; "4/102" is auto-stripped to "4"', example: '4' },
  ...
  raw_purchase: [
    ...
    { name: 'set_name',      required: false, description: 'Set or expansion name',                  example: 'Base Set' },
    { name: 'card_number',   required: false, description: 'Card number within the set — numerator only; "58/102" is auto-stripped to "58"', example: '58' },
    { name: 'currency',      required: false, description: 'Currency code',                          example: 'USD', accepted: 'USD, CAD, EUR, GBP, JPY, AUD. Defaults to USD.' },
